...
SingleSensorLayout::SingleSensorLayout(): sensorLabel(new QLabel("Seleziona un singolo sensore")), layout(new QHBoxLayout()), option(new SensorOptions()), rightLayout(new QVBoxLayout()), info(new InfoLayout()), chart(new ChartsLayout()) {
